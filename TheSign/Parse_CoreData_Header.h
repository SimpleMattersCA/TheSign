...
#ifndef TheSign_Parse_CoreData_Header_h
#define TheSign_Parse_CoreData_Header_h
#endif
...
//Tag
#define CD_TAG (@"Tag")
#define CD_TAG_ID (@"uid")
#define CD_TAG_NAME (@"name")
#define CD_TAG_DETAILS (@"details")
#define CD_TAG_CLASS (@"fromClass")
#define CD_TAG_SET (@"fromSet")

#define PARSE_TAG (@"Tag")
#define PARSE_TAG_ID (@"uid")
#define PARSE_TAG_NAME (@"name")
#define PARSE_TAG_DETAILS (@"details")
#define PARSE_TAG_CLASS (@"class")
#define PARSE_TAG_SET (@"set")

//TagClass
#define CD_TAGCLASS (@"TagClass")
#define CD_TAGCLASS_ID (@"uid")
#define CD_TAGCLASS_NAME (@"name")

#define PARSE_TAGCLASS (@"TagClass")
#define PARSE_TAGCLASS_ID (@"uid")
#define PARSE_TAGCLASS_NAME (@"name")

//TagSet
#define CD_TAGSET (@"TagSet")
#define CD_TAGSET_WEIGHT (@"weight")
